...
// pl1 coin counter
draw_sprite_stretched(spr_guibg_blue,0,6,6,220,60);
...
if (obj_pc1.quest1==1) && (obj_npc1.broken_ant!=0)
	{
	draw_text(10,22,"Unidentified Artifacts:"  +string(obj_npc1.broken_ant) );
	}
...
if (obj_pc1.quest1==1) && (obj_npc1.broken_gen!=0)
	{
	draw_text(10,36,"Unidentified Bones:"  +string(obj_npc1.broken_gen) );
	}
...
if (obj_npc1.txtbox==1)
	{
	draw_sprite_stretched(spr_guibg_blue,0,400,300,380,60);
